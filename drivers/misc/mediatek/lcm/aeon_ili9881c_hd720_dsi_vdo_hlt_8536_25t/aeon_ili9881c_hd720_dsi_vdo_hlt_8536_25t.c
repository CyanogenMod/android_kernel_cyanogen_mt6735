...
#ifdef BUILD_LK
	printf("LK lcm_compare_id ili9881 hlt 0.25 buffer[0] = 0x%x,buffer[1] = 0x%x,buffer[2] = 0x%x, \n",buffer[0],buffer[1],buffer[2]);
#else
	printk("Kernel lcm_compare_id ili9881 hlt 0.25 buffer[0] = 0x%x,buffer[1] = 0x%x,buffer[2] = 0x%x\n",buffer[0],buffer[1],buffer[2]);
#endif
	if((buffer[0]==0x05))
	{
		return 1;
...
LCM_DRIVER aeon_ili9881c_hd720_dsi_vdo_hlt_8536_25t_lcm_drv = 
{
    .name			= "aeon_ili9881c_hd720_dsi_vdo_hlt_8536_25t",
