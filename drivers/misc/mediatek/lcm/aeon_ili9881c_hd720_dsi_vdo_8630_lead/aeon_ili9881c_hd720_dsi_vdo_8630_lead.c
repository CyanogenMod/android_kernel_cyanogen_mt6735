...
#ifdef BUILD_LK
	printf("LK lcm_compare_id ili9881 lide buffer[0] = 0x%x,buffer[1] = 0x%x,buffer[2] = 0x%x, \n",buffer[0],buffer[1],buffer[2]);
#else
	printk("Kernel lcm_compare_id ili9881 lide buffer[0] = 0x%x,buffer[1] = 0x%x,buffer[2] = 0x%x\n",buffer[0],buffer[1],buffer[2]);
#endif
	if((buffer[0]==0x00))
	{
		return 1;
