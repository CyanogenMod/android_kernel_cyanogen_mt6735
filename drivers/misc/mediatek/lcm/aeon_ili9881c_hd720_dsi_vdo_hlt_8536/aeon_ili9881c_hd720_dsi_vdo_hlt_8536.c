...
{0x6F, 1,{0xb3}},                // rEg vCl + pumping rAtio VGH=3x VGL=-2.5x
...
#ifdef BUILD_LK
	printf("LK lcm_compare_id ili9881 buffer[0] = 0x%x,buffer[1] = 0x%x,buffer[2] = 0x%x\n",buffer[0],buffer[1],buffer[2]);
#else
...
LCM_DRIVER aeon_ili9881c_hd720_dsi_vdo_hlt_8536_lcm_drv = 
{
    .name			= "aeon_ili9881c_hd720_dsi_vdo_hlt_8536",
